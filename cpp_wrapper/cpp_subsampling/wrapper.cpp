...
static PyObject* batch_subsampling(PyObject* self, PyObject* args, PyObject* keywds)
{
    ...
    // Parse the input  
    if (!PyArg_ParseTupleAndKeywords(args, keywds, "OO|$OOfsii", kwlist, 
        &points_obj, &batches_obj, &features_obj, &classes_obj, 
        &sampleDl, &method_buffer, &max_p, &verbose))
    {
    ...
    bool use_feature = (features_obj != NULL);
    bool use_classes = (classes_obj != NULL);
    ...
    if ((int)PyArray_NDIM((PyArrayObject*)points_array) != 2 || 
        (int)PyArray_DIM((PyArrayObject*)points_array, 1) != 3)
    {
        Py_XDECREF(points_array);
        Py_XDECREF(batches_array);
        Py_XDECREF(features_array);
    ...
    // Check that the input arrays respect the number of points
    ...
    vector<PointXYZ> original_points((PointXYZ*)PyArray_DATA((PyArrayObject*)points_array),
                                      (PointXYZ*)PyArray_DATA((PyArrayObject*)points_array) + N);
    vector<int> original_batches((int*)PyArray_DATA((PyArrayObject*)batches_array),
                                 (int*)PyArray_DATA((PyArrayObject*)batches_array) + Nb);
    vector<float> original_features;
    vector<int> original_classes;
    if (use_feature)
        original_features = vector<float>((float*)PyArray_DATA((PyArrayObject*)features_array),
                                            (float*)PyArray_DATA((PyArrayObject*)features_array) + N * fdim);
    if (use_classes)
        original_classes = vector<int>((int*)PyArray_DATA((PyArrayObject*)classes_array),
                                         (int*)PyArray_DATA((PyArrayObject*)classes_array) + N * ldim);
    ...
    npy_intp batches_dims[1] = { (npy_intp)Nb };
...
static PyObject* cloud_subsampling(PyObject* self, PyObject* args, PyObject* keywds)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, keywds, "O|$OOfsi", kwlist, 
